...
one non-blocking row: branch protection and secret scanning cannot be turned on
...
`1 open, 129 fixed, 3 parked, 13 declined.`
...
### `publish-the-repo` — 1 row (1 nice-to-have)
